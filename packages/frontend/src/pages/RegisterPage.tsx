    ...
    <div className="max-w-md mx-auto mt-12 animate-fade-in">
      <div className="bg-tarkov-dark rounded-lg p-8 shadow-lg border border-tarkov-secondary hover:border-tarkov-accent transition-all duration-300">
        <div className="text-center mb-8">
          <FontAwesomeSVGIcons.Target className="text-tarkov-accent mx-auto mb-4 animate-bounce" size={48} />
          <h1 className="text-3xl font-tarkov font-bold text-tarkov-accent">Join the Casino</h1>
          <p className="text-gray-400 mt-2">Become a Tarkov Operator</p>
        </div>
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 bg-tarkov-secondary border rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-tarkov-accent focus:border-transparent transition-all duration-200 ${
                usernameError ? 'border-tarkov-danger' : 'border-tarkov-primary'
              }`}
              placeholder="Choose your operator name"
            />
            {usernameError && (
              <p className="text-tarkov-danger text-sm mt-1 animate-pulse">{usernameError}</p>
            )}
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-3 py-2 pr-10 bg-tarkov-secondary border rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-tarkov-accent focus:border-transparent transition-all duration-200 ${
                  confirmPasswordError ? 'border-tarkov-danger' : 'border-tarkov-primary'
                }`}
            ...
            {confirmPasswordError && (
              <p className="text-tarkov-danger text-sm mt-1 animate-pulse">{confirmPasswordError}</p>
            )}
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-400">
            ...
            <Link to="/login" className="text-tarkov-accent hover:text-orange-400 transition-colors font-medium">
              Login here
            </Link>
          </p>
        </div>
