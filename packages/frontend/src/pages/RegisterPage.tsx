    ...
    <div className="max-w-md mx-auto mt-12 animate-fade-in">
      <div className="bg-tarkov-dark rounded-lg p-8 shadow-lg border border-tarkov-secondary hover:border-tarkov-accent transition-all duration-300">
        <div className="text-center mb-8">
          <FontAwesomeSVGIcons.UserPlus className="text-tarkov-accent mx-auto mb-4 animate-bounce" size={48} />
          <h1 className="text-3xl font-tarkov font-bold text-tarkov-accent">Join Casino</h1>
        ...
        <div className="mt-6 text-center space-y-2">
          ...
          <p className="text-gray-400">
            ...
            <a href="/login" className="text-tarkov-accent hover:text-orange-400 transition-colors font-medium">
              Login here
            </a>
          </p>
        </div>
