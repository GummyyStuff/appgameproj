...
describe('RouletteWheel Accuracy', () => {
  describe('Base Rotation Calculation', () => {
    test('calculates correct rotation for number 0 (first position)', () => {
      const rotation = calculateWinningRotation(0, wheelNumbers)
      expect(rotation).toBe(0) // First position should be 0 degrees
    })

    test('calculates correct rotation for number 32 (second position)', () => {
    ...
    test('calculates correct rotation for number 26 (last position)', () => {
    ...
    test('returns 0 for null winning number', () => {
    ...
    test('handles empty wheel array', () => {
  ...
  describe('Final Rotation Calculation', () => {
    test('adds minimum spins to base rotation', () => {
    ...
    test('accounts for current rotation', () => {
    ...
    test('calculates different final rotations for different numbers', () => {
    ...
    test('handles null winning number', () => {
  ...
  describe('Visual Alignment', () => {
    test('positions winning number correctly relative to pointer', () => {
    ...
    test('maintains consistent segment spacing', () => {
      const segmentAngle = 360 / wheelNumbers.length
  ...
  describe('Performance', () => {
    test('calculates rotations quickly for all numbers', () => {
