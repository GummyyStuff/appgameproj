...
const achievementDefinitions: Omit<AchievementDefinition, '$id' | 'createdAt'>[] = [
  ...
  // Stock Market Trading Achievements
  {
    achievementId: 'first-trade',
    title: 'First Trade',
  ...
  {
    achievementId: 'wall-street-wolf',
  ...
  {
    achievementId: 'profit-streak-10',
    title: 'Unstoppable',
  ...
  {
    achievementId: 'huge-win',
    title: 'Huge Win',
    description: 'Profit ₽10,000 in a single trade',
    category: 'special',
    rarity: 'epic',
    maxProgress: 10000,
    rewardType: 'currency',
  ...
  {
    achievementId: 'mega-win',
    title: 'Mega Win',
    description: 'Profit ₽25,000 in a single trade',
    category: 'special',
    rarity: 'legendary',
    maxProgress: 25000,
    rewardType: 'currency',
  ...
  {
    achievementId: 'bull-market-king',
    title: 'Bull Market King',
    description: 'Earn ₽50,000 total from stock trading',
    category: 'progression',
    rarity: 'epic',
    maxProgress: 50000,
    rewardType: 'currency',
  ...
  {
    achievementId: 'market-maker',
    title: 'Market Maker',
    description: 'Trade 1000 shares total',
    category: 'progression',
    rarity: 'rare',
    maxProgress: 1000,
    rewardType: 'currency',
  ...
  {
    achievementId: 'quick-trader',
    title: 'Quick Trader',
    description: 'Complete a buy and sell within 30 seconds',
    category: 'special',
    rarity: 'rare',
    maxProgress: 1,
    rewardType: 'currency',
  ...
  {
    achievementId: 'perfect-timing',
    title: 'Perfect Timing',
    description: 'Buy at the lowest point and sell at the highest',
    category: 'special',
    rarity: 'legendary',
    maxProgress: 1,
    rewardType: 'currency',
