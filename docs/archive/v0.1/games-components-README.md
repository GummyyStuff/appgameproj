---
title: "Case Opening Game Components Documentation"
audience: developer
layer: frontend
status: stable
tags: [components, case-opening, architecture]
last_updated: "2026-08-07"
---

# Case Opening Game Components Documentation

> **Note**: For the most up-to-date developer documentation, see [Developer Guide](../user-guides/CASE_OPENING_DEVELOPER_GUIDE.md)
