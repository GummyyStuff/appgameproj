...
- **Corner**: Bet on four numbers forming a square (8:1 payout)
- **Line**: Bet on six numbers (5:1 payout)
- **Column**: Bet on 12 numbers in a column (2:1 payout)
- **Dozen**: Bet on 12 numbers (2:1 payout)
- **Red/Black**: Bet on color (1:1 payout)
- **Odd/Even**: Bet on number parity (1:1 payout)
- **Low/High**: Bet on 1-18 or 19-36 (1:1 payout)
