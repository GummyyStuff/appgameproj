---
title: "Appwrite Realtime Guide"
audience: developer
layer: database
status: stable
tags: [appwrite, realtime, websocket]
...
Appwrite Realtime provides WebSocket-based live data synchronization, enabling real-time features like instant balance updates, live leadertoards, chat systems, and game notifications.
